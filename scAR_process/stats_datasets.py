...
umi_atac.to_csv('output/datasets_atac_umi.txt',sep='\t')

plt.figure(figsize=(10,5))
sns.boxplot(x="sample",y="n_umi",data=atac_rna,palette="Set1",linewidth=1,fliersize=1)
plt.ylim(0,10000)
plt.savefig('output/datasets_atac_umi.png')
